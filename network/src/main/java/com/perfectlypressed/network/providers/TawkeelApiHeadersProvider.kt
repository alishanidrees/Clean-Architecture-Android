...
interface PerfectlyPressedApiHeadersProvider : Provider<HashMap<String, String>>

class DefaultPerfectlyPressedApiHeadersProvider @Inject constructor(
    private val localeProvider: AppLocaleProvider,
    private val authorizationTokenProvider: AuthorizationTokenProvider,
    @ApplicationContext private val context: Context
) : PerfectlyPressedApiHeadersProvider {
